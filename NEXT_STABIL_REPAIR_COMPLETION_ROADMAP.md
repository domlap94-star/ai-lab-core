...
| Stan rejestracji | R03-A4 pozostaje zaakceptowane na `92cc3aa38f0a81ff40e3798981970bd2e45b6206` dla manifestu `8F20A7845473097EE74019966583EC3F121139C4B562265F9A7391FAFAF6BE4B`; cały R03 nadal `WAITING_APPROVAL / WAITING_ESCROW_DECISION`. R04-A3 pozostaje zaakceptowane jako `SOURCE_INTEGRATION_ACCEPTED / TEST_STAGING_RECORDED / NOT_DEPLOYED`. Właściciel zaakceptował R05-A1 source `d31e105427acd40733e91c4d4b46f0412b0f95ad` i evidence `05995ab2c87438c5786a9f874793e95d2bf5b296` jako `SOURCE_AND_SYNTHETIC_TESTS_ACCEPTED / NOT_DEPLOYED`; R05-A2 jest `IN_PROGRESS / SOURCE_AND_OFFLINE_TEST_ONLY`. R04/R05 pozostają `IN_PROGRESS`; R06–R24 nieuruchomione |
| Checkpoint ID | `R05-20260911T215344Z-A2-UPLOAD-BOUNDARY-START` |
| Ostatnia aktualizacja operacyjna UTC | `2026-09-11T21:53:44Z` |
| Aktualny wykonawca / sesja | Codex / R05-A2 source/offline test: mapowanie zatwierdzonych bajtów przez realną kolejkę i worker do atrapionej ostatniej granicy; bez browsera, normalnego startupu i realnego eksportu |
| Aktywny pakiet / podetap | `R05 / A2 upload boundary` — `IN_PROGRESS / SOURCE_AND_OFFLINE_TEST_ONLY`; cały R05 nadal `IN_PROGRESS` |
...
| Ostatnia faktycznie zakończona czynność | Potwierdzono odbiór A1 i odtworzono na preimage A2 lukę TOCTOU: po poprawnym hash checku workera kontrolowana podmiana przed `setInputFiles` sprawiła, że fake granica otrzymała inne bajty. Nie uruchomiono Playwright/browsera ani sieci |
| Potwierdzone testy bieżącego wykonania | A2 fail-before: `FAIL_BEFORE_TOCTOU_REPRODUCED`, exit `1`; zatwierdzony SHA-256 `a75d6618...cad5`, otrzymany po podmianie `b8d04743...5e61b`; log SHA-256 `0C33EC33EC0B620581C02ED2F5778E8EFF4D9E3DF864186A9659200F63AA3BC9`. Pass-after jeszcze `NOT_RUN` |
...
| Niezakończone procesy i skutki operacyjne | Brak procesów lub zasobów wykonawczych A2. Istnieje wyłącznie nowy chroniony katalog dowodowy `R05_A2_UPLOAD_BOUNDARY_20260911T215159Z` z syntetycznym logiem. Aplikacja, dispatchery, Supervisor HTTP, browser, Temporary Chat, modele i realny eksport: `NOT_RUN` |
| Najnowsza notatka przekazania | `docs/recovery/checkpoints/20260911T215344Z-R05-A2-START.md`; poprzedni checkpoint: `docs/recovery/checkpoints/20260911T194028Z-R05-A1-CLAIM-CERTAINTY.md` |
...
| Blokada / wymagana decyzja | A2 ma potwierdzony fail-before, lecz pass-after i pełna macierz lokalnego łańcucha są jeszcze `NOT_RUN`. Real uploader/browser/export/end-to-end i UI dopuszczenia pozostają `NOT_VERIFIED` |
| Jeden następny bezpieczny krok | Zaimplementować małą kontrolę buforowanych, zweryfikowanych bajtów w kodzie używanym przez CLI oraz konserwatywny brak automatycznego retry po możliwym rozpoczęciu uploadu; następnie uruchomić wyłącznie izolowane testy Node/Python |
...
| R05 | IN_PROGRESS | `R05-20260911T215344Z-A2-UPLOAD-BOUNDARY-START` / SOURCE AND OFFLINE TEST | Właściciel zaakceptował A1 source `d31e105427acd40733e91c4d4b46f0412b0f95ad` i evidence `05995ab2c87438c5786a9f874793e95d2bf5b296` jako `SOURCE_AND_SYNTHETIC_TESTS_ACCEPTED / NOT_DEPLOYED`. A2 odtworzyło TOCTOU worker path → `setInputFiles`; pass-after jeszcze `NOT_RUN`. Real browser/uploader/external end-to-end pozostają `NOT_VERIFIED` |
| R06 | PLANNED | — | — |
| R07 | PLANNED | — | — |
| R08 | PLANNED | — | — |
| R09 | PLANNED | — | — |
