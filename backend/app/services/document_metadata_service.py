...
class DocumentMetadataService:
    ...
    def extract(
        ...
        *,
        ...
        try:
            if normalized_content_type == "message/rfc822":
                return self._extract_rfc822(path)
    ...
    def _extract_rfc822(
        ...
        result = DocumentEmailService().extract(
            path=path,
        )
